...
var globalObj$2 = globalThis;
if (!globalObj$2[GLOBAL_EVENT_STORAGE_KEY]) globalObj$2[GLOBAL_EVENT_STORAGE_KEY] = new AsyncLocalStorage();
var eventStorage = globalObj$2[GLOBAL_EVENT_STORAGE_KEY];
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-IVvDJsnH.js");
...
var GLOBAL_STORAGE_KEY$1 = /* @__PURE__ */ Symbol.for("tanstack-start:start-storage-context");
var globalObj$1 = globalThis;
if (!globalObj$1[GLOBAL_STORAGE_KEY$1]) globalObj$1[GLOBAL_STORAGE_KEY$1] = new AsyncLocalStorage();
var startStorage$1 = globalObj$1[GLOBAL_STORAGE_KEY$1];
function getStartContext$1(opts) {
  const context = startStorage$1.getStore();
  if (!context && opts?.throwIfNotFound !== false) throw new Error(`No Start context found in AsyncLocalStorage. Make sure you are using the function within the server runtime.`);
  return context;
}
var getStartOptions = () => getStartContext$1().startOptions;
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-CprX-nqu.js").then((n) => n.r),
