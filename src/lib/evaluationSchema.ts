export type ScoreLevel = "not_observed" | "emerging" | "developing" | "proficient" | "advanced";

export const SCORE_LEVELS = [
  {
    value: "not_observed" as ScoreLevel,
    label_fr: "Non observé",
    label_ar: "غير ملاحظ",
    color: "bg-red-50 text-red-700",
  },
  {
    value: "emerging" as ScoreLevel,
    label_fr: "Émergent",
    label_ar: "ناشئ",
    color: "bg-orange-50 text-orange-700",
  },
  {
    value: "developing" as ScoreLevel,
    label_fr: "En développement",
    label_ar: "في التطور",
    color: "bg-yellow-50 text-yellow-700",
  },
  {
    value: "proficient" as ScoreLevel,
    label_fr: "Compétent",
    label_ar: "مختص",
    color: "bg-green-50 text-green-700",
  },
  {
    value: "advanced" as ScoreLevel,
    label_fr: "Avancé",
    label_ar: "متقدم",
